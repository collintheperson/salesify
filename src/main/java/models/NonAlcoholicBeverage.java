 ...
 */
public class NonAlcoholicBeverage implements Beverage {
    private String name;
    ...
    public boolean equals(Object o) {
        ...
        NonAlcoholicBeverage that = (NonAlcoholicBeverage) o;
    ...
    public NonAlcoholicBeverage(String name, double price, boolean sale){
        this.name = name;
        this.price = price;
        this.sale = sale;
    }
